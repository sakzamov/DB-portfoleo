...
/skills - используй для добавдения нового навыка.
/projects - помогает посмотреть список и небольшое описание твоих проектов.
/delete - удалят проект для надобности.
/update_projects - помогает изменить что-то в одном из проектов.
